...
contract EventImplementation is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        libStorage.globalEventRegistry = IGlobalEventRegistry(_globalEventRegistry);
    ...
    function createEvent(
        ...
        libStorage.globalEventRegistry.registerEvent(
            id,
            name,
            startTime,
            endTime,
        ...
        emit CreatedEvent(msg.sender, name, startTime, endTime);
    }
    ...
    function sponsorEvent(uint256 eventId, uint256 amount) external nonReentrant  {
        ...
        // Record sponsorship globally
        s.globalEventRegistry.recordSponsorship(msg.sender, eventId, amount);
    }
